...
<div class="outer-scroll-box">
    <!-- Inner scroll box content goes here -->
    <div class="inner-scroll-box">
        <p># 🏭 Manufacturing Defect Reduction Analysis  
...
📬 *Feel free to explore the project files and analysis for more detail on the methodology and findings.*</p>
